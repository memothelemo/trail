...
rojo sourcemap default.project.json -o sourcemap.json --watch \
    & rojo sourcemap modules/trail/build.project.json -o modules/trail/sourcemap.json --watch \
    & rojo sourcemap modules/trail-subscriber/build.project.json -o modules/trail-subscriber/sourcemap.json --watch \
